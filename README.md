...
This Python code is the algorithm for the paper: Fast impedance prediction for power distribution network using deep learning, which has been published on **International Journal of Numerical Modeling: Electronic Networks, Devices and Fields.** (https://onlinelibrary.wiley.com/doi/10.1002/jnm.2956)
